...
[![FortiGate](https://img.shields.io/badge/FortiGate-HA%20%7C%20FIPS--CC-red?style=flat-square&logo=fortinet)](https://github.com/rickrobinson2014-net)
[![PaloAlto](https://img.shields.io/badge/Palo%20Alto-PCNSE%20Certified-00AEEF?style=flat-square)](https://github.com/rickrobinson2014-net)
[![Elastic SIEM](https://img.shields.io/badge/Elastic-SIEM%20%7C%20SOC%20Lab-005571?style=flat-square&logo=elastic)](https://github.com/rickrobinson2014-net)
[![SD-WAN](https://img.shields.io/badge/FortiGate%20SD--WAN-ADVPN%20%7C%20FortiOS-red?style=flat-square&logo=fortinet)](https://github.com/rickrobinson2014-net)
...
- 🔥 **Daily drivers:** FortiGate 600F, 200F, 100E, 40F, 60F HA (FIPS-CC, FortiOS 7.4.x), PaloAlto VM-300, FortiGate SD-WAN
...
- 🎓 **Certifications:** M.S. | NSE 4/5 (FortiGate Firewall) | PCNSA/PCNSE (Palo Alto Firewall) | Cisco SDWAN

---

## 🗂️ Featured Lab Projects

### 🔐 [FortiGate-HA-FIPS-SOC-Lab](https://github.com/rickrobinson2014-net/FortiGate-HA-FIPS-SOC-Lab)
...
### 🌐 [SDWAN-ADVPN-BGP-OSPF-Lab](https://github.com/rickrobinson2014-net/SDWAN-ADVPN-BGP-OSPF-Lab)
...
### 🔴 [PaloAlto-PCNSA-Lab-Series](https://github.com/rickrobinson2014-net/PaloAlto-PCNSA-Lab-Series)
...
### 🔭 [Elastic-SOC-Detection-Lab](https://github.com/rickrobinson2014-net/Elastic-SOC-Detection-Lab)
...
### 🔒 [SSL-Decryption-PKI-Lab](https://github.com/rickrobinson2014-net/SSL-Decryption-PKI-Lab)
...
### 📊 [FortiAnalyzer-FortiManager-Runbooks](https://github.com/rickrobinson2014-net/FortiAnalyzer-FortiManager-Runbooks)
...
### 📈 [Zabbix-Infrastructure-Monitoring-Lab](https://github.com/rickrobinson2014-net/Zabbix-Infrastructure-Monitoring-Lab)
